 ...
 * @param {string} args.outputFile - File to write JSON environment details for future scripting
...
Application.prototype.deploy = function deploy(args) {
    ...
    var deploymentInfo = new DeploymentInfo(environment, archive, outputFile);
    ...
    return archive.upload()
        ...
        .then(deploymentInfo.toJSON.bind(deploymentInfo))
        .catch(winston.error);
};
