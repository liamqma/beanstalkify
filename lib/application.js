 ...
 * @param {string} stack Stack to provision (e.g. '64bit Amazon Linux 2015.03 v2.0.0 running Node.js')
 ...
 * @constructor
 */
function Application(credentials, archivePath, cname, stack, config, outputFile) {
    ...
    this.environment = new Environment(this.archive, cname, this.stack, config, elasticbeanstalk);
